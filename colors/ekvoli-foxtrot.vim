...
hi Normal			guifg=#ffffff guibg=#001535#003505
hi Error			guibg=#0090a0 gui=bold,italic,undercurl guisp=#ffffff#ffffff
hi ErrorMsg			guifg=#ffffff guibg=#287eff gui=bold,italic#27ff3d gui=bold,italic
hi Visual			guibg=#30c01f guifg=#ffffff gui=bold#ffffff gui=bold
hi VisualNOS		guibg=#60a060 guifg=#ffffff gui=bold#ffffff gui=bold
hi Todo				guibg=#38d000 guifg=#ffffff gui=underline#ffffff gui=underline

hi NonText			guifg=#64f07f

hi Search 			guibg=#66996e guifg=#ffffff gui=bold#ffffff gui=bold
hi IncSearch 		guibg=#66996e guifg=#ffffff gui=bold#ffffff gui=bold

hi SpecialKey		guifg=#50e000
hi Directory		guifg=#50e000
hi Title			guifg=#bbe6ad guibg=#202060 gui=underline#206040 gui=underline
hi def link         mkdHeading       Title
hi WarningMsg		guifg=#bbe6ad
hi WildMenu			guifg=#ffffff guibg=#0080c0#1fc000
hi Pmenu			guifg=#ffffff guibg=#005090#079000
hi PmenuSel			guifg=#ffffff guibg=#3070c0#2fc037
hi ModeMsg			guifg=#6be221
hi MoreMsg			guifg=#6be221 gui=bold
hi Question			guifg=#6be221 gui=none

hi MatchParen		guifg=#ffffff guibg=#3070c0 gui=bold#2fc037 gui=bold

hi StatusLine		guifg=#ffffff guibg=#104075 gui=bold#0f7512 gui=bold
hi StatusLineNC		guifg=#64f06f guibg=#104075 gui=none#0f7512 gui=none
hi VertSplit		guifg=#2f8532 guibg=#305885 gui=none#2f8532 gui=none
hi Folded			guifg=#67f664 guibg=#122555 gui=italic#115520 gui=italic
hi FoldColumn		guifg=#ffffff guibg=#103366 gui=none#0f6617 gui=none
hi LineNr			guifg=#50b050 gui=bold

hi DiffAdd			guibg=#3fa01f guifg=#ffffff gui=bold#ffffff gui=bold
hi DiffChange		guibg=#3fa01f guifg=#ffffff gui=bold#ffffff gui=bold
hi DiffDelete		guibg=#38802f guifg=#ffffff gui=none#ffffff gui=none
hi DiffText			guibg=#70a098 guifg=#ffffff gui=bold#ffffff gui=bold
...
hi TabLineSel       guifg=#ffffff guibg=#3f8fff#3eff4e
hi TabLine          guifg=#ffffff guibg=#001535#003505
...
hi otlTodo    gui=bold,underline guifg=#ffffff guibg=#00a0d0#38d000
hi otlTagRef  guifg=#ffffff guibg=#8070a0#70a098
hi otlTagDef  guifg=#ffffff guibg=#005090#079000
