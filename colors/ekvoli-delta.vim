...
hi Normal			guifg=#ffffff guibg=#001535#351f00
hi Error			guibg=#3fa000 gui=bold,italic,undercurl guisp=#ffffff#ffffff
hi ErrorMsg			guifg=#ffffff guibg=#287eff gui=bold,italic#ffa927 gui=bold,italic
hi Visual			guibg=#c05f1f guifg=#ffffff gui=bold#ffffff gui=bold
hi VisualNOS		guibg=#a08060 guifg=#ffffff gui=bold#ffffff gui=bold
hi Todo				guibg=#d02f00 guifg=#ffffff gui=underline#ffffff gui=underline

hi NonText			guifg=#f0c464

hi Search 			guibg=#998866 guifg=#ffffff gui=bold#ffffff gui=bold
hi IncSearch 		guibg=#998866 guifg=#ffffff gui=bold#ffffff gui=bold

hi SpecialKey		guifg=#e01f00
hi Directory		guifg=#e01f00
hi Title			guifg=#e6bbad guibg=#202060 gui=underline#606020 gui=underline
hi def link         mkdHeading       Title
hi WarningMsg		guifg=#e6bbad
hi WildMenu			guifg=#ffffff guibg=#0080c0#c04000
hi Pmenu			guifg=#ffffff guibg=#005090#904000
hi PmenuSel			guifg=#ffffff guibg=#3070c0#c07f2f
hi ModeMsg			guifg=#e23721
hi MoreMsg			guifg=#e23721 gui=bold
hi Question			guifg=#e23721 gui=none

hi MatchParen		guifg=#ffffff guibg=#3070c0 gui=bold#c07f2f gui=bold

hi StatusLine		guifg=#ffffff guibg=#104075 gui=bold#75440f gui=bold
hi StatusLineNC		guifg=#f0b564 guibg=#104075 gui=none#75440f gui=none
hi VertSplit		guifg=#855d2f guibg=#305885 gui=none#855d2f gui=none
hi Folded			guifg=#f6aa64 guibg=#122555 gui=italic#554111 gui=italic
hi FoldColumn		guifg=#ffffff guibg=#103366 gui=none#66420f gui=none
hi LineNr			guifg=#b08050 gui=bold

hi DiffAdd			guibg=#a03f1f guifg=#ffffff gui=bold#ffffff gui=bold
hi DiffChange		guibg=#a03f1f guifg=#ffffff gui=bold#ffffff gui=bold
hi DiffDelete		guibg=#804f2f guifg=#ffffff gui=none#ffffff gui=none
hi DiffText			guibg=#90a070 guifg=#ffffff gui=bold#ffffff gui=bold
...
hi TabLineSel       guifg=#ffffff guibg=#3f8fff#ffaf3e
hi TabLine          guifg=#ffffff guibg=#001535#351f00
...
hi otlTodo    gui=bold,underline guifg=#ffffff guibg=#00a0d0#d02f00
hi otlTagRef  guifg=#ffffff guibg=#8070a0#90a070
hi otlTagDef  guifg=#ffffff guibg=#005090#904000
