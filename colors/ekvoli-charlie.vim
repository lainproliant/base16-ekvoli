...
hi Normal			guifg=#ffffff guibg=#350007
hi Error			guibg=#a08800 gui=bold,italic,undercurl guisp=#ffffff
hi ErrorMsg			guifg=#ffffff guibg=#ff2748 gui=bold,italic
hi Visual			guibg=#c01f57 guifg=#ffffff gui=bold
hi VisualNOS		guibg=#a06070 guifg=#ffffff gui=bold
hi Todo				guibg=#d0006c guifg=#ffffff gui=underline

hi NonText			guifg=#f0646d

hi Search 			guibg=#99666a guifg=#ffffff gui=bold
hi IncSearch 		guibg=#99666a guifg=#ffffff gui=bold

hi SpecialKey		guifg=#e00088
hi Directory		guifg=#e00088
hi Title			guifg=#e6adc9 guibg=#603020 gui=underline
hi def link         mkdHeading       Title
hi WarningMsg		guifg=#e6adc9
hi WildMenu			guifg=#ffffff guibg=#c0004f
hi Pmenu			guifg=#ffffff guibg=#90002b
hi PmenuSel			guifg=#ffffff guibg=#c02f4c
hi ModeMsg			guifg=#e2219b
hi MoreMsg			guifg=#e2219b gui=bold
hi Question			guifg=#e2219b gui=none

hi MatchParen		guifg=#ffffff guibg=#c02f4c gui=bold

hi StatusLine		guifg=#ffffff guibg=#750f26 gui=bold
hi StatusLineNC		guifg=#f0647d guibg=#750f26 gui=none
hi VertSplit		guifg=#852f42 guibg=#852f42 gui=none
hi Folded			guifg=#f6648b guibg=#551114 gui=italic
hi FoldColumn		guifg=#ffffff guibg=#660f1d gui=none
hi LineNr			guifg=#b05068 gui=bold

hi DiffAdd			guibg=#a01f60 guifg=#ffffff gui=bold
hi DiffChange		guibg=#a01f60 guifg=#ffffff gui=bold
hi DiffDelete		guibg=#802f4b guifg=#ffffff gui=none
hi DiffText			guibg=#a08c70 guifg=#ffffff gui=bold
...
hi TabLineSel       guifg=#ffffff guibg=#ff3e5e
hi TabLine          guifg=#ffffff guibg=#350007
...
hi otlTodo    gui=bold,underline guifg=#ffffff guibg=#d0006c
hi otlTagRef  guifg=#ffffff guibg=#a08c70
hi otlTagDef  guifg=#ffffff guibg=#90002b
